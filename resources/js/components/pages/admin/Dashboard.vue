        ...
        <nav id="nav-sidebar" class="col-md-2 d-none d-md-block bg-dark text-info sidebar">
            <div class="sidebar-sticky">
                <div class="align-items-center pb-2 mb-3 mt-3 border-bottom">
                    ...
                    <h5 class="h5">{{ userName }} (Admin)</h5>
                </div>
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <div class="nav-link">
                            <span data-feather="home"></span>
                            <router-link to="/admin" class="text-info">Dashboard</router-link>
                        </div>
                    </li>
                    <li class="nav-item">
                        <div class="nav-link">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <div class="nav-link active" href="#">
                                        <span data-feather="home"></span>
                                        <router-link to="/admin/roles-management" class="text-info">Roles</router-link>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <div class="nav-link active" href="#">
                                        <span data-feather="home"></span>
                                        <router-link to="/admin/user-management" class="text-info">Users</router-link>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="ml-3">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <div class="nav-link active" href="#">
                                        <span data-feather="home"></span>
                                        <router-link to="/admin/category-management" class="text-info">Expense Categories</router-link>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <div class="nav-link active" href="#">
                                        <span data-feather="home"></span>
                                        <router-link to="/admin/expense-management" class="text-info">Expenses</router-link>
                                    </div>
                                </li>
                            </ul>
                        </div>
...
import GraphPie from 'vue-graph/src/components/pie.js'
  ...
  export default {
    ...
    methods: {
        ...
        checkRoute() {
          if (this.$route.name == 'My Expenses (Admin)') {
